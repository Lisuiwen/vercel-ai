# AI SDK、Next.js 与 OpenAI 聊天示例（Telemetry）

本示例演示如何将 [AI SDK](https://ai-sdk.dev/docs) 与 [Next.js](https://nextjs.org/) 和 [OpenAI](https://openai.com) 结合，构建带 [OpenTelemetry 支持](https://ai-sdk.dev/docs/ai-sdk-core/telemetry) 的流式聊天机器人。
