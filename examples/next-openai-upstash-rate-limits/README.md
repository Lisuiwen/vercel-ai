# AI SDK、Next.js 与 OpenAI 聊天示例（Vercel KV 限流）

本示例演示如何将 [AI SDK](https://ai-sdk.dev/docs) 与 [Next.js](https://nextjs.org/) 和 [OpenAI](https://openai.com) 结合，使用 [Vercel KV](https://vercel.com/docs/storage/vercel-kv) 构建带限流的流式聊天机器人。
