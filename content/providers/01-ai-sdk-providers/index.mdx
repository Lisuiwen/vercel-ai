---
title: AI SDK 提供商
description: 了解如何在 AI SDK 中使用各提供商。
---

# AI SDK 提供商

AI SDK 内置多个提供商，可用于对接不同的语言模型：

<OfficialModelCards />

此外还有基于[语言模型规范](./community-providers/custom-providers)实现的[社区提供商](./community-providers)。

<CommunityModelCards />

## 提供商支持

并非所有提供商都支持 AI SDK 的全部功能。下表列出了常用模型在能力上的简要对比：
...
<Note>
  上表并未穷尽全部模型。更多模型请见各提供商文档页面及提供商官网。
</Note>
