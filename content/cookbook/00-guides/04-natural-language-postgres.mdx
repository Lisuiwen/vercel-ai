---
title: 自然语言 Postgres
description: 学习如何构建可用自然语言与 PostgreSQL 数据库对话的 Next.js 应用
tags: ['agents', 'next', 'tools']
---

# 自然语言 Postgres 指南

本指南介绍如何构建使用 AI 以自然语言与 PostgreSQL 交互的应用。
...
完整项目见 [natural-language-postgres.vercel.app](https://natural-language-postgres.vercel.app)。
