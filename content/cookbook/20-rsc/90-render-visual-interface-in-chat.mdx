---
title: 在聊天中渲染可视化界面
description: 学习如何使用 AI SDK 与 React Server Components 在聊天中渲染可视化界面
...
在 [`tools`](/docs/reference/ai-sdk-core/generate-text#tools) 中定义多个函数时，模型可根据用户意图推理应调用的函数，无需自行实现复杂的路由逻辑。
