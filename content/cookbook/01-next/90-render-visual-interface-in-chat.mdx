---
title: 在聊天中渲染可视化界面
description: 学习如何在 Next.js 中使用 AI SDK 在聊天中渲染可视化界面
tags: ['next', 'generative user interface']
---

# 在聊天中渲染可视化界面

能调用[工具](/docs/ai-sdk-core/tools-and-tool-calling)的语言模型，还可以将 React 组件流式传到客户端，从而在聊天中渲染可视化界面。
...
构建一个助手：通过调用 `getWeatherInformation` 工具获取任意城市天气。工具调用时不返回纯文本，而是在客户端渲染展示天气信息的 React 组件。
